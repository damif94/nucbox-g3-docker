...
Surfaces accounts, advisors, virtual groups, holdings, and ETL job status from
apimax.picodix.com. No write/upload tools are exposed (deliberately — see
README). Engaged only for customers that list "maximus" in their `toolpacks:`
config.
...
MAXIMUS_TIMEOUT    Per-request timeout in seconds (default 30).
"""
